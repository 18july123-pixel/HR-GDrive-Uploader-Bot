...
DEFAULT_COMMANDS = [
    ...
    BotCommand(command="mega_login", description="Save a Mega.nz account"),
    BotCommand(command="mega_accounts", description="List saved Mega.nz accounts"),
    BotCommand(command="mega_useaccount", description="Choose the default Mega.nz account"),
    BotCommand(command="mega_logout", description="Disconnect your Mega.nz account"),
    BotCommand(command="me", description="My Drive info"),
    BotCommand(command="upload", description="Upload a file to Drive"),
    BotCommand(command="megaupload", description="Upload a file to Mega.nz"),
